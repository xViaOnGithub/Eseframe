...
$function eseframe:registry/item/proxy/steps/02_merge_item_proxy_into_list with entity @s Inventory[$(index)].components."minecraft:custom_data".eseframe_api.item_proxy