...
execute unless data storage eseframe:cache {initialize:{registry:{allow_registry_register:"recipe"}}} run return run say [Eseframe API] Error! Custom recipes can only be added during function tag `#eseframe_api:register/recipes`.
