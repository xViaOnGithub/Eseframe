...
$execute if predicate {condition:"minecraft:value_check",value:$(block),range:1} run return run function eseframe:registry/recipe_tag/crafting/block/attempt {id:"$(id)",namespace:"$(namespace)"}
