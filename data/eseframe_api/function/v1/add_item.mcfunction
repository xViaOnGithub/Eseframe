...
execute unless data storage eseframe:cache initialize.registry.allow_registry_register run return run say [Eseframe API] Error! Custom items can only be registered during function tag `#eseframe_api:register/items`.
