...
execute unless data storage eseframe:cache initialize.include.add_content.Allowed run return run say [Eseframe API] Error! Custom items can only be registered during function `<addon_namespace>:eseframe_api/content`.
