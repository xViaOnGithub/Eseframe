...
$loot give @s loot {type:"minecraft:generic",pools:[{rolls:$(count),entries:[{type:"minecraft:item",name:"minecraft:command_block",functions:[{function:"minecraft:set_components",components:{"!minecraft:rarity":{},"!minecraft:item_name":{},"!minecraft:item_model":{},"!minecraft:max_stack_size":{}}},{function:"minecraft:set_components",components:$(components)},{function:"minecraft:set_custom_data",tag:{Eseframe:{id:"$(id)",namespace:"$(namespace)"}}}]}]}]}