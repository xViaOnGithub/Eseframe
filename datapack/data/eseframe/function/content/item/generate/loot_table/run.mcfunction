...
$execute if data storage eseframe:content item[{id:"$(id)",namespace:"$(namespace)"}].properties.override_template_item run data modify storage eseframe:cache tick.content.item.generate.loot_table.output set value {type:"minecraft:generic",pools:[{rolls:$(count),entries:[{type:"minecraft:item",functions:[]}]}]}
$execute if data storage eseframe:content item[{id:"$(id)",namespace:"$(namespace)"}].properties.override_template_item run data modify storage eseframe:cache tick.content.item.generate.loot_table.output.pools[0].entries[0].name set from storage eseframe:content item[{id:"$(id)",namespace:"$(namespace)"}].properties.override_template_item

# Otherwise, start with a dummy item
$execute unless data storage eseframe:content item[{id:"$(id)",namespace:"$(namespace)"}].properties.override_template_item run data modify storage eseframe:cache tick.content.item.generate.loot_table.output set value {type:"minecraft:generic",pools:[{rolls:$(count),entries:[{type:"minecraft:loot_table",value:"eseframe:dummy_item",functions:[]}]}]}
