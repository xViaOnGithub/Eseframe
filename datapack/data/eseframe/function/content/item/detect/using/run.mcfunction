...
# TODO: Detect press
execute if function eseframe:content/item/detect/using/steps/01_check_if_press run say item changed since last use



# Call a function that runs the use_hold function tag in the item's respective folder
function eseframe:content/item/detect/using/steps/03_call_use_hold_function_tag_in_item_folder with entity @s SelectedItem.components."minecraft:custom_data".eseframe