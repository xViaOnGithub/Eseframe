...
function eseframe:content/item/detect/consume/steps/01_call_function_tag_in_item_folder with entity @s SelectedItem.components."minecraft:custom_data".eseframe