...
## Outputs a formatted dialog to storage eseframe:cache session.generate_menus.dialog
...
data modify storage eseframe:cache session.generate_menus.dialog set value {type:"minecraft:notice",body:[{type:"minecraft:plain_message",contents:"* But nobody came."}],title:"Eseframe Registered Items (Dev Menu)"}
...
function eseframe:utils/list_loop/start {function_path:"eseframe:generate_menus/01_prepare_macro",list_path:"storage eseframe:content item"}
