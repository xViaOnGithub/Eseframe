...
$execute store result storage eseframe:cache tick.registry.recipe_tag.crafting.recipe_id byte 1 run function eseframe:registry/recipe/crafting/player/attempt {id:"$(id)",namespace:"$(namespace)"}
