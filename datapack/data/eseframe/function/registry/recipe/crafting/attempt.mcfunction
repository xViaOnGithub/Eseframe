...
$execute unless data storage eseframe:registry recipe[{id:"$(id)",namespace:"$(namespace)"}] run say recipe not found!
$execute unless data storage eseframe:registry recipe[{id:"$(id)",namespace:"$(namespace)"}].ingredients[] run say recipe has no ingredients!
$execute unless data storage eseframe:registry recipe[{id:"$(id)",namespace:"$(namespace)"}].ingredients[] run return fail
...
## Clear items
$function eseframe:util/list_loop/run {pass_index:false,function:"eseframe:registry/recipe/crafting/steps/02_clear_ingredient",list_path:'storage eseframe:registry recipe[{id:"$(id)",namespace:"$(namespace)"}].ingredients'}
